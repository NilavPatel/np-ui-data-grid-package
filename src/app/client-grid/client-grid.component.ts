...
export class ClientGridComponent implements OnInit {
  ...
  ngOnInit() {
    this.gridColumns = [
      ...
      { dataField: "LastName", visible: true, width: 200, caption: "Last Name", dataType: DataTypes.String, filterEnabled: true, sortEnabled: true },
      { dataField: "BirthDate", visible: true, width: 200, caption: "Birth Date", dataType: DataTypes.Date, filterEnabled: true, sortEnabled: true, cellTemplate: this.birthDateColumnTemplate },
      ...
      { dataField: "Active", visible: true, width: 200, caption: "Is Active?", dataType: DataTypes.Boolean, filterEnabled: true, sortEnabled: true },
